...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        carController.save(new Car(0, 4, 2020, 560.40, "Ford F-150", "Lariat", "JKL-6789", true, false));
        carController.save(new Car(0, 4, 2022, 110.90, "Mercedes-Benz C-Class", " C300", "UVW-2345", true, false));
        carController.save(new Car(0, 2, 2023, 240.30, "Volkswagen Golf", "GTI", "PQR-7890", false, false));

      
        clientController.save(new CommonClient("elizabeth","1234"));
